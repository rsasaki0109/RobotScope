...
| Layer | Features |
|-------|----------|
| Map | **Boost bin alpha** — `parseBoostLaneletMap()` boundary extract + Map panel **(Boost bin)** label |
| v1.6 carry-over | Action preempt · timeline · cancel · tracking · gateways |
...
**Out of scope (v1.7 alpha)**

- Full lanelet topology · regulatory yield refs · cross-boost portability

## v1.6.0 (GA)

Preempt controls on v1.5 action timeline. See [release notes](RobotScope/docs/release/v1.6.0.md) and [CHANGELOG.md](RobotScope/CHANGELOG.md).
...
- [Migration v1.6 beta → GA](RobotScope/docs/migration/v1.6-beta-to-ga.md)
- [Known limitations](RobotScope/docs/known-limitations.md)
...
Dedicated action timeline panel on v1.4 action gateway. See [release notes](RobotScope/docs/release/v1.5.0.md) and [CHANGELOG.md](RobotScope/CHANGELOG.md).

**Shipped**

| Layer | Features |
|-------|----------|
| Live | **Action timeline panel** — sidebar event history for Fibonacci goals |
| v1.4 carry-over | Cancel goal · tracking badge · goal send · service · Twist |

**Docs**

- [Action gateway guide](RobotScope/docs/action-gateway.md)
- [Migration v1.5 beta → GA](RobotScope/docs/migration/v1.5-beta-to-ga.md)
- [Known limitations](RobotScope/docs/known-limitations.md)

**Out of scope (v1.5)**

- Cross-session persistence · native Lanelet2 boost bin

## v1.5.0-beta.0

Dedicated action timeline panel on v1.4 action gateway. See [release notes](RobotScope/docs/release/v1.5.0-beta.0.md) and [CHANGELOG.md](RobotScope/CHANGELOG.md).
...
- [Action gateway guide](RobotScope/docs/action-gateway.md)
- [Migration v1.5 alpha → beta](RobotScope/docs/migration/v1.5-alpha-to-beta.md)
- [Known limitations](RobotScope/docs/known-limitations.md)

**Out of scope (v1.5 beta)**

- Cross-session persistence · preempt controls · native Lanelet2 boost bin

## v1.5.0-alpha.0

Dedicated action timeline panel on v1.4 action gateway. See [release notes](RobotScope/docs/release/v1.5.0-alpha.0.md) and [CHANGELOG.md](RobotScope/CHANGELOG.md).
